...
const telegramProducts = {
    premium: [
        { id: 30, name: "Premium 1oy (Kirib)", price: 40000, icon: "fab fa-telegram" },
        { id: 31, name: "Premium 1yil (Kirib)", price: 280000, icon: "fab fa-telegram" },
        { id: 32, name: "Premium 3oy (Kirmasda)", price: 160000, icon: "fab fa-telegram" },
        { id: 33, name: "Premium 6oy (Kirmasda)", price: 217000, icon: "fab fa-telegram" },
        { id: 34, name: "Premium 1yil (Kirmasda)", price: 387000, icon: "fab fa-telegram" }
    ],
